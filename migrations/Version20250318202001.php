 ...
 */
final class Version20250318202001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE date_types (id INT AUTO_INCREMENT NOT NULL, date_type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE inventor (id INT AUTO_INCREMENT NOT NULL, person_type_id INT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, phone_number VARCHAR(255) DEFAULT NULL, INDEX IDX_29C96264E7D23F1A (person_type_id), UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE inventor ADD CONSTRAINT FK_29C96264E7D23F1A FOREIGN KEY (person_type_id) REFERENCES person_type (id)');
        ...
        ('zha','Zhuang; Chuang'),
        ('zul','Zulu')");
        $this->addSql("INSERT INTO business_type (code, title)
        VALUES
        ...
        $this->addSql("INSERT INTO person_type (name)
        VALUES
        ('Applicant'),
        ('Inventor'),
        ('Attorney'),
        ('Co-Inventor')");
        $this->addSql("INSERT INTO category (type)
        VALUES
        ('Utility'),
        ('Design'),
        ('Plant'),
        ('Provisional')");
        $this->addSql("INSERT INTO stats (stat)
        VALUES
        ('Preliminary'),
        ('Submitted'),
        ('Waiting Response'),
        ...
        ('Retired'),
        ('Rejected')");
        $this->addSql("INSERT INTO date_types (date_type)
        VALUES
        ('Application Date'),
        ('Publication Date'),
        ('Effective Date'),
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inventor DROP FOREIGN KEY FK_29C96264E7D23F1A');
